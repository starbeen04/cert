<template>
  <div class="student-layout" :class="{ 'sidebar-collapsed': isCollapsed }">
    <!-- Sidebar -->
    <nav class="sidebar" :class="{ 'collapsed': isCollapsed }">
      ...
      >
        <el-menu-item
          v-for="route in studentMenuRoutes"
          :key="route.path"
          :index="route.path"
          ...
          <el-dropdown trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item @click="handleCommand('progress')">
...
// 학습자 메뉴 라우트들
const studentMenuRoutes = computed(() => [
  {
    path: '/student',
...
.student-layout.sidebar-collapsed {
